...
namespace Footart.Utilities
{
    public static class Util
    {
        ...
        public static string GetEnumDescription(System.Type enumType, string key)
        {
            ...
            if (!string.IsNullOrEmpty(key))
            {
                ...
                {
                    if (System.Convert.ToInt32(enumValue) == System.Convert.ToInt32(key))
                    {
                        fi = enumType.GetField((enumValue.ToString()));
                        da = (DescriptionAttribute)System.Attribute.GetCustomAttribute(fi,
